...
$(function() {
    ...
    $("#sparkline5").sparkline([18, 22, 38, 20], {
        type: 'pie',
        height: '100',
        sliceColors: ['#17a2b8', '#28a745', '#2D6E84', '#dc3545'],
...
function drawDocSparklines() {
    ...
    $('#compositebar').sparkline([7, 3, 10, 5, 4, 8, 6, 4, 2, 4, 5, 3, 4, 5], { composite: true, fillColor: false, lineColor: '#dc3545' });
    ...
    $('.sparktristatecols').sparkline('html', { type: 'tristate', colorMap: { '-2': '#17a2b8', '2': '#17a2b8' } });

    // Composite line charts, the second using values supplied via javascript
    $('#compositeline').sparkline('html', { fillColor: false, changeRangeMin: 0, chartRangeMax: 10 });
    $('#compositeline').sparkline([7, 3, 10, 5, 4, 8, 6, 4, 2, 4, 5, 3, 4, 5], { composite: true, fillColor: false, lineColor: '#dc3545', changeRangeMin: 0, chartRangeMax: 10 });
    ...
    // Discrete charts
    $('.discrete1').sparkline('html', { type: 'discrete', lineColor: '#17a2b8', xwidth: 18 });
    $('#discrete2').sparkline('html', { type: 'discrete', lineColor: '#17a2b8', thresholdColor: '#dc3545', thresholdValue: 4 });
